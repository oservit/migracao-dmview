-- Ordem: 058 | Tabela: TB___CFG_MUXS__TB | Depth: 3
INSERT INTO TB___CFG_MUXS__TB
(
CL___PROXY_CODE__CL,
CL___MUX_NO__CL,
CL___OBJECT__CL,
...
FROM CLARO.TB___CFG_MUXS__TB src
...
WHERE NOT EXISTS (
    SELECT 1 FROM TB___CFG_MUXS__TB dest WHERE dest.ERP_CODE = src.CL___MUX_LOCAL_ID__CL
);
COMMIT;