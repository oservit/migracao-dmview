-- Ordem: 073 | Tabela: TB___ST_PORTS__TB | Depth: 4
INSERT INTO TB___ST_PORTS__TB
(
CL___PROXY_CODE__CL,
CL___MUX_NO__CL,
...
FROM CLARO.TB___ST_PORTS__TB src
...
WHERE NOT EXISTS (
    SELECT 1 FROM TB___ST_PORTS__TB dest WHERE dest.ERP_CODE = src.CL___CARD_NO__CL
);
COMMIT;