...
src.MEMBERSHIP_TYPE,
src.CONTROL,
LOWER(RAWTOHEX(STANDARD_HASH(TRIM(CAST(src.PROXY_CODE AS VARCHAR2(100))) || '|' || TRIM(CAST(src.DEV_NO AS VARCHAR2(100))) || '|' || TRIM(CAST(src.DEV_LOCAL_ID AS VARCHAR2(100))) || '|' || TRIM(CAST(src.SLOT AS VARCHAR2(100))) || '|' || TRIM(CAST(src.PORT AS VARCHAR2(100))) || '|' || TRIM(CAST(src.VLAN_RANGE_START AS VARCHAR2(100))), 'MD5'))) AS ERP_CODE
