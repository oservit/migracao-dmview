...
src.MODEL_CODE,
src.PORT_FUNCTION,
LOWER(RAWTOHEX(STANDARD_HASH(TRIM(CAST(src.ID_CIRCUIT_END AS VARCHAR2(100))) || '|' || TRIM(CAST(src.SLOT_NO AS VARCHAR2(100))) || '|' || TRIM(CAST(src.PORT_NO AS VARCHAR2(100))), 'MD5'))) AS ERP_CODE
