...
src.TEST_SRC,
src.TEST_START_TIME,
LOWER(RAWTOHEX(STANDARD_HASH(TRIM(CAST(src.PROXY_CODE AS VARCHAR2(100))) || '|' || TRIM(CAST(src.DEV_NO AS VARCHAR2(100))) || '|' || TRIM(CAST(src.DEV_LOCAL_ID AS VARCHAR2(100))) || '|' || TRIM(CAST(src.SLOT_NO AS VARCHAR2(100))) || '|' || TRIM(CAST(src.PORT_NO AS VARCHAR2(100))) || '|' || TRIM(CAST(src.TEST_ID AS VARCHAR2(100))), 'MD5'))) AS ERP_CODE
