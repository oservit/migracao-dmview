...
src.OBJ_INSTANCE,
src.OBJ_VALUE,
LOWER(RAWTOHEX(STANDARD_HASH(TRIM(CAST(src.ID_CIRCUIT AS VARCHAR2(100))) || '|' || TRIM(CAST(src.OBJECT AS VARCHAR2(100))) || '|' || TRIM(CAST(src.OBJ_INSTANCE AS VARCHAR2(100))), 'MD5'))) AS ERP_CODE
